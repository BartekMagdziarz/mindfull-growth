<template>
  ...
  >
    <!-- Row 1: Title + [hover: menu] + Status -->
    <div class="flex items-center gap-2">
      <h3 class="min-w-0 flex-1 truncate text-lg font-semibold tracking-[-0.02em] text-on-surface">
        {{ item.title }}
      </h3>
    ...
    <!-- Row 2: Badges + Entities -->
    <div
      v-if="nonStatusBadges.length > 0 || (item.linkedEntities && item.linkedEntities.length > 0)"
