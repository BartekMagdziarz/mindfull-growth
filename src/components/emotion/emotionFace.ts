...
export const FACE_SPECS: Record<string, FaceSpec> = {
  ...
  // --- Rozszerzenie HELP (Wysoka energia / Nieprzyjemne) ---
  "Urażony": { eyes: "dot", brow: "anger", mouth: ["frown", 2.2], accent: "none" },
  "Zniecierpliwiony": { eyes: "half", brow: "one", mouth: ["flat", 0], accent: "none" },
  "Rozdarty": { eyes: "dot", brow: "one", mouth: ["wavy", 1.3], accent: "none" },
  "Speszony": { eyes: "glance", brow: "worry", mouth: ["wavy", 1.2], accent: "blush" },
  "Wyniosły": { eyes: "half", brow: "one", mouth: ["smirkdown", 0], accent: "none" },
  "Lekceważący": { eyes: "half", brow: "flat", mouth: ["smirk", 0], accent: "none" },
  // --- Rozszerzenie LELP (Niska energia / Nieprzyjemne) ---
  "Załamany": { eyes: "closed", brow: "sad", mouth: ["frown", 3.6], accent: "tear" },
  "Zrezygnowany": { eyes: "half", brow: "sad", mouth: ["flat", 0], accent: "none" },
  "Pusty": { eyes: "half", brow: "flat", mouth: ["flat", 0], accent: "none" },
  "Stęskniony": { eyes: "up", brow: "sad", mouth: ["wist", 1.3], accent: "none" },
  "Żałujący": { eyes: "closed", brow: "sad", mouth: ["frown", 2.2], accent: "none" },
}
