    ...
    >
      <div v-if="currentStep === 'intro'" class="space-y-4">
        <AppCard padding="lg" class="space-y-4">
          ...
          <div class="space-y-2">
            <EmotionSelector
              :label="t('exerciseWizards.legacyLetter.intro.emotionLabel')"
    ...
    >
      <div v-if="currentStep === 'write'" class="space-y-4">
        <AppCard padding="lg" class="space-y-4">
          ...
          <p class="text-sm text-on-surface-variant leading-relaxed">
            {{ t('exerciseWizards.legacyLetter.write.description') }}
          </p>
          <ExerciseStepWhy :text="tg('exerciseWizards.legacyLetter.write.why')" />
          <div class="neo-embedded p-3">
          ...
          <div v-if="coreValues.length > 0" class="space-y-1">
            ...
            <div class="flex flex-wrap gap-1.5">
              <span
                ...
                :key="value"
                class="exercise-pill text-xs px-2.5 py-0.5"
              >
                {{ value }}
              </span>
            </div>
    ...
    >
      <div v-if="currentStep === 'summary'" class="space-y-4">
        <AppCard variant="raised" padding="lg" class="space-y-6">
          ...
          <div class="space-y-2">
            <EmotionSelector
              :label="t('exerciseWizards.legacyLetter.summary.emotionLabel')"
