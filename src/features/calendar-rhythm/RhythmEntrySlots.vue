...
import type { EntriesProjection } from './rhythmProjections'
...
.entry-slots i { display: inline-block; width: 9px; height: 9px; border-radius: 999px; background: var(--cp-mark-dim); }
.entry-slots i.on { background: var(--cp-mark); }
.entry-bar { position: relative; display: inline-block; width: 34px; height: 8px; border-radius: 4px; background: var(--cp-card); overflow: hidden; }
