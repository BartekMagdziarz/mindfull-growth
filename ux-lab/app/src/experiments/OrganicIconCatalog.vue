...
const collection = computed(() => [1, 2, 3].includes(Number(route.query.collection)) ? Number(route.query.collection) : 0)
const newCount = organicIcons.filter(i => i.collection === 3).length
