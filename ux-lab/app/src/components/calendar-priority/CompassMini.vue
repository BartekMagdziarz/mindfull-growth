...
import { COMPASS } from '~lab/lab/calendarPriorityData'
...
.compass-mini__axis small { color: rgb(var(--color-on-surface-variant)); font-size: 11px; font-weight: 700; }
.compass-mini__axis b { display: inline-flex; gap: 2px; }
.compass-mini__axis i { display: inline-block; width: 5px; height: 11px; border-radius: 2px; background: rgb(var(--sky-200)); }
